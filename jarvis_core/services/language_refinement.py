...
_PTPT_REPLACEMENTS: tuple[tuple[str, str], ...] = (
    ...
    (r"\bsalvar\b", "guardar"),
    (r"\bvocê me fez\b", "o Senhor fez-me"),
    (r"\ba sua pergunta me fez\b", "a sua pergunta fez-me"),
    (r"\bme motiva\b", "motiva-me"),
    (r"\bnão quero te fazer\b", "não o quero fazer"),
    (r"\bposso te fazer\b", "posso fazê-lo"),
    (r"\bsutil\b", "subtil"),
    (r"\bestou curioso\b", "estou curiosa"),
    (r"\bfiquei curioso\b", "fiquei curiosa"),
    (r"\bfico curioso\b", "fico curiosa"),
    (r"\bme faz curioso\b", "deixa-me curiosa"),
    (r"\bme deixa curioso\b", "deixa-me curiosa"),
    (r"\bme deixa satisfeito\b", "deixa-me satisfeita"),
    (r"\bfico satisfeito\b", "fico satisfeita"),
    (r"\bengajamento\b", "envolvimento"),
    (r"\bcom si\b", "consigo"),
    (r"\bpor que não\b", "porque não"),
    (r"\btambém um pouco divertido\b", "também um pouco divertida"),
    (r"\bestou pronto\b", "estou pronta"),
    (r"\bfiquei pronto\b", "fiquei pronta"),
    (r"\bestou focado\b", "estou focada"),
    (r"\bem sua mente\b", "na sua mente"),
